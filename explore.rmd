...
```{r}
playMusic = function(notes_pitch = NULL, notes_duration = NULL, tempo = 240) 
{
  . <- NULL
  note <- NULL
  octave <- NULL
...
playMusic(notes_pitch=soloMelodyNotes$Note, tempo=bpm, notes_duration=soloMelodyNotes$duration*bpm/60)
